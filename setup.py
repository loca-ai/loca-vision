...
setup(
    ...
    description="Vision backend for Loca",  # Optional
    ...
    package_dir={"": "loca_vision"},  # Optional
    ...
    #
    packages=find_packages(where="loca_vision"),  # Required
